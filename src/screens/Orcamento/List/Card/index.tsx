...
export function Card({ data, onPress }: Props) {
    ...
    const getStatusDotStyles = (status: string) => {
        switch (status) {
            case 'Aprovado': return styles.statusDotAprovado;
            case 'Enviado':  return styles.statusDotEnviado;
            case 'Recusado': return styles.statusDotRecusado;
            default:         return styles.statusDotRascunho;
        }
    };
    ...
    const getStatusStyles = (status: string) => {
        switch (status) {
            ...
            case 'Recusado': return styles.statusRecusado;
            default:         return styles.statusRascunho;
        }
    };

    const getStatusContainerStyles = (status: string) => {
        switch (status) {
            case 'Aprovado': return styles.containerAprovado;
            case 'Enviado':  return styles.containerEnviado;
            case 'Recusado': return styles.containerRecusado;
            default:         return styles.containerRascunho;
        }
    };
